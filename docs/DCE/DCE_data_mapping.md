...
| **K线价格** | 
| `open_price` | 期货成交量统计 | 通过成交量统计数据计算 | 开盘价（需从成交量统计数据计算） | 
| `high_price` | 期货成交量统计 | 通过成交量统计数据计算 | 最高价（需从成交量统计数据计算） | 
| `low_price` | 期货成交量统计 | 通过成交量统计数据计算 | 最低价（需从成交量统计数据计算） | 
| `close_price` | 期货成交量统计 | 通过成交量统计数据计算 | 收盘价（需从成交量统计数据计算） |
| **买方五档价格** |
